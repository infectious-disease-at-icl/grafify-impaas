mainPanel2 <- list(layout_columns(col_widths = 8,
                                   card("",
...
mainPanel2.1 <- list(layout_columns(col_widths = 10,
                                  card("",
                                       tagList(#h4("Types of graphs with grafify"),
                                         tags$img(src="shiny1_all_graphs.png", 
                                                  align="left", 
...
mainPanel2.2 <- list(layout_columns(col_widths = 10,
                                  card("",
                                       tagList(#h4("Types of graphs with grafify"),
...
mainPanel2.3 <- list(layout_columns(col_widths = 10,
                                    card("",
                                         tagList(#h4("Types of graphs with grafify"),
...
#,
#                                                 tags$h6("the types of graphs can be chosen from ", tags$strong("Box 6"#), ". Boxes/bars/point errorbar/violins and data distribution can be plotted."),
#                                         tags$h6("When a Grouping factor is chosen in ", tags$strong("Box 3"), " i.e., #data are from two-way ANOVA type experimental designs, the same types of graphs will be available, but will look as #follows."),
#                                         tags$img(src="shiny2_graphs_types.png",
#                                                  align = "left",
#                                                  width = "80%"),
