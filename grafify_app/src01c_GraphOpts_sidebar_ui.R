#sidebar panel for default page
sidebar_panel1 <- list(layout_columns(#colwidths 12 ensures the full sidebar fits in the full width
  col_widths = c(12, 12), fluidRow(
    column(
      12,
      HTML(paste(
        tags$h3("8"),
      ...
      accordion(
        ...
        #default colour
        #conditional panel for histogram binsizes
        conditionalPanel(
          "input.graphType == 'Histogram plot'",
          card(card_header("Binsizes"), uiOutput("Binsize"))
        )
      ),
      accordion(
        open = TRUE,
      ...
      #conditional panel for SD errorbars
      conditionalPanel(
        "input.graphType == 'Bar graph' ||
                     input.graphType == 'Point & Errorbar'",
